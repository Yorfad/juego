...
gbox("wall_back_l", (3.9, 3.2, 0.2), (-2.05, 1.50, 4.0), M_WALL)   # hueco de puerta
gbox("wall_back_r", (2.9, 3.2, 0.2), ( 2.55, 1.50, 4.0), M_WALL)
gbox("door_lintel", (1.2, 1.0, 0.2), ( 0.50, 2.60, 4.0), M_WALL)
gbox("dframe_l",    (0.1, 2.10, 0.16), (-0.06, 1.05, 3.98), M_METAL)
gbox("dframe_r",    (0.1, 2.10, 0.16), ( 1.06, 1.05, 3.98), M_METAL)
