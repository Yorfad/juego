...
gbox("wall_back_l", (3.5, 3.2, 0.2), (-2.25, 1.50, 4.0), M_WALL)   # hueco de puerta x[-0.5, 1.3]
gbox("wall_back_r", (2.7, 3.2, 0.2), ( 2.65, 1.50, 4.0), M_WALL)
gbox("door_lintel", (1.8, 1.1, 0.2), ( 0.40, 2.65, 4.0), M_WALL)
gbox("dframe_l",    (0.12, 2.15, 0.20), (-0.56, 1.07, 3.98), M_METAL)
gbox("dframe_r",    (0.12, 2.15, 0.20), ( 1.36, 1.07, 3.98), M_METAL)
gbox("dsill",       (2.00, 0.06, 0.30), ( 0.40, 0.03, 4.02), M_METAL)
